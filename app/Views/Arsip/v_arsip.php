                            ...
                            foreach ($arsip as $key => $value) { ?>
                             <tr>
                                 ...
                                 <td class="text-center">
                                     <a href="<?= base_url('Arsip/Edit/' . $value['id_arsip']) ?>" class="btn btn-warning btn-sm btn-flat"><i class="fa fa-pencil"></i></a>
         ...
         <div class="modal-dialog">
             <div class="modal-content">
                 ...
                 <div class="modal-footer justify-content-between">
                     ...
                     <a href="<?= base_url('Arsip/Deletedata/' . $value['id_arsip']) ?>" class="btn btn-danger btn-flat">Delete</a>
                 </div>
             </div>
         </div>
     </div>
