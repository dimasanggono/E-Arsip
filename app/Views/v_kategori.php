                    ...
                    foreach ($kategori as $key => $value) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-sm btn-warning" data-toggle="modal" data-target="#edit-data<?= $value['id_kategori'] ?>"><i class="fa fa-pencil"></i></button>
                                <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete-data<?= $value['id_kategori'] ?>"><i class="fa fa-trash"></i></button>
                            </td>
                        </tr>
                    <?php    } ?>
                </tbody>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input name="nama_kategori" value="<?= $value['nama_kategori'] ?>" class="form-control" placeholder="Nama Departemen">
                    </div>
                </div>
                <div class="modal-footer justify-content-between ">
    ...
    <div class="modal fade" id="delete-data<?= $value['id_kategori'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4>Apakah Anda Yakin Ingin Menghapus Data <b> <?= $value['nama_kategori'] ?> </b> ?</h4>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default pull-left btn-flat" data-dismiss="modal">Close</button>
